...
namespace ToolsExample
{
	...
	public class MainForm : Form
	{
        ...
        private CheckBox chkHighlightPOSTags;
		...
		private void InitializeComponent()
		{
            ...
            this.chkHighlightPOSTags = new System.Windows.Forms.CheckBox();
            ...
            // _btnParse
            // 
            this._btnParse.Location = new System.Drawing.Point(355, 3);
            ...
            // _btnPosTag
            // 
            this._btnPosTag.Location = new System.Drawing.Point(179, 3);
            ...
            // _btnChunk
            // 
            this._btnChunk.Location = new System.Drawing.Point(267, 3);
            ...
            // _btnTokenize
            // 
            this._btnTokenize.Location = new System.Drawing.Point(91, 3);
            ...
            // _btnNameFind
            // 
            this._btnNameFind.Location = new System.Drawing.Point(443, 3);
            ...
            // _btnSplit
            // 
            this._btnSplit.Location = new System.Drawing.Point(3, 3);
            ...
            // _btnGender
            // 
            this._btnGender.Location = new System.Drawing.Point(534, 3);
            ...
            // _btnSimilarity
            // 
            this._btnSimilarity.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this._btnSimilarity.Location = new System.Drawing.Point(622, 3);
            this._btnSimilarity.Name = "_btnSimilarity";
            this._btnSimilarity.Size = new System.Drawing.Size(82, 23);
            ...
            // _btnCoreference
            // 
            this._btnCoreference.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this._btnCoreference.Location = new System.Drawing.Point(712, 3);
            this._btnCoreference.Name = "_btnCoreference";
            this._btnCoreference.Size = new System.Drawing.Size(82, 23);
            ...
            // 
            this.splitContainer1.Panel2.Controls.Add(this.pbr);
            this.splitContainer1.Panel2.Controls.Add(this.chkHighlightPOSTags);
            ...
            // _txtOut
            // 
            this._txtOut.BorderStyle = System.Windows.Forms.BorderStyle.None;
            ...
            // chkHighlightPOSTags
            // 
            this.chkHighlightPOSTags.AutoSize = true;
            this.chkHighlightPOSTags.Location = new System.Drawing.Point(653, 70);
            this.chkHighlightPOSTags.Name = "chkHighlightPOSTags";
            this.chkHighlightPOSTags.Size = new System.Drawing.Size(119, 17);
            this.chkHighlightPOSTags.TabIndex = 165;
            this.chkHighlightPOSTags.Text = "Highlight POS Tags";
            this.chkHighlightPOSTags.UseVisualStyleBackColor = true;
            this.chkHighlightPOSTags.CheckedChanged += new System.EventHandler(this.chkHighlightPOSTags_CheckedChanged);
            // 
            // cboFind
            // 
            ...
            // panel1
            // 
            this.panel1.Controls.Add(this._btnGender);
            this.panel1.Controls.Add(this._btnPosTag);
            this.panel1.Controls.Add(this._btnCoreference);
            this.panel1.Controls.Add(this._btnChunk);
            this.panel1.Controls.Add(this._btnSplit);
            this.panel1.Controls.Add(this._btnParse);
            this.panel1.Controls.Add(this._btnSimilarity);
            this.panel1.Controls.Add(this._btnTokenize);
            this.panel1.Controls.Add(this._btnNameFind);
            ...
            // _txtIn
            // 
            this._txtIn.Dock = System.Windows.Forms.DockStyle.Fill;
            this._txtIn.Location = new System.Drawing.Point(0, 0);
            this._txtIn.Multiline = true;
            this._txtIn.Name = "_txtIn";
            this._txtIn.ScrollBars = System.Windows.Forms.ScrollBars.Both;
            this._txtIn.Size = new System.Drawing.Size(800, 138);
            this._txtIn.TabIndex = 26;
            // 
            // pbr
            // 
            this.pbr.Dock = System.Windows.Forms.DockStyle.Bottom;
            this.pbr.Location = new System.Drawing.Point(0, 89);
            this.pbr.Name = "pbr";
            this.pbr.Size = new System.Drawing.Size(800, 10);
            this.pbr.Style = System.Windows.Forms.ProgressBarStyle.Continuous;
            this.pbr.TabIndex = 166;
            // 
            // MainForm
            // 
	    ...
	    internal void LoadPOSTags()
	    {
	        ...
	        cboFind.Items.Add("-LRB-"); 
            cboFind.Items.Add("-RRB-");
        ...
        private void _btnTokenize_Click(object sender, EventArgs e)
        {
            ...
            foreach (var sentence in sentences)
            {
                ...
                BoldText(_txtOut, tokens, Color.Black);
            }
        ...
        private void _btnPosTag_Click(object sender, EventArgs e)
        {
            ...
            pbr.Value = 0;
            pbr.Maximum = cboFind.Items.Count;

            if (chkHighlightPOSTags.Checked)
            {
                foreach (object t in cboFind.Items)
                {
                    pbr.Value += 1;

                    string tag = t as string;
                    if (string.Compare(tag, "JJ", StringComparison.Ordinal) == 0)
                        BoldText(_txtOut, new string[] {tag + CommonStrings.Space}, Color.Green);
                    else if (string.Compare(tag, "RB", StringComparison.Ordinal) == 0)
                        BoldText(_txtOut, new string[] { tag + CommonStrings.Space}, Color.Brown);
                    else if (string.Compare(tag, "VB", StringComparison.Ordinal) == 0)
                        BoldText(_txtOut, new string[] { tag + CommonStrings.Space}, Color.Blue);
                    else if (string.Compare(tag, "NN", StringComparison.Ordinal) == 0)
                        BoldText(_txtOut, new string[] { tag + CommonStrings.Space}, Color.Purple);
                    else
                        BoldText(_txtOut, new string[] { tag + CommonStrings.Space}, Color.Black);
                }

                BoldText(_txtOut, new string[] { ","}, Color.Black);
                BoldText(_txtOut, new string[] { "."}, Color.Black);
            }
            pbr.Value = 0;
        }
	    ...
	    private void HighlightText(RichTextBox myRtb, string word, Color color)
	    {
	        ...
	        {
	            if (index > 0)
	                myRtb.Select(index - 1, word.Length);
	            else
	            {
	    ...
	    public void BoldText(RichTextBox myRtb, string[] words, Color c)
	    {
        ...
        private void chkHighlightPOSTags_CheckedChanged(object sender, EventArgs e)
        {
