...
namespace OpenNLP.Tools.Chunker
{
	...
	public class MaximumEntropyChunker : IChunker
	{
		...
		/// </summary>
		protected Util.BeamSearch Beam { get; }

	    /// <summary>
	    /// The model used to assign chunk tags to a sequence of tokens.
	    /// </summary>
	    protected SharpEntropy.IMaximumEntropyModel Model  { get; }
		...
		public virtual string[] AllTags()
		{
			...
			for (var currentTag = 0; currentTag < Model.OutcomeCount; currentTag++)
			{
		...
		protected virtual bool ValidOutcome(string outcome, Util.Sequence sequence)
		{
			return true;
		}
